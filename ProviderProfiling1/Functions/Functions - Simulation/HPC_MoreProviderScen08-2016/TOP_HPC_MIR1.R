...
source("fun_zh_sampling_sim_ex.R")
...
## RUN FUNCTION 
SIM_RES_EXTRA <- zh_sampling_ex(provs=provs,b.yi=b.yi,n.perzh=n.perzh,funs=funs,sims=sims,
                  seed=seed,trim=trim,l.plots=F,ref="A",sav=T,plot.t=1:4,confs=confs,cors=cors)
